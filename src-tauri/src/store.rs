...
// ─── Data types (移入 domain/ 模块) ───
// 所有类型定义已移至 src-tauri/src/domain/
// 此处保留 DataStore 结构体及 JSON 读写方法，后续逐步迁移至 storage/
...
// ArticleBlueprint + OutlineSection 已移入 domain/document.rs
