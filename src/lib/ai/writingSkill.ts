...
## 行文要求
- 不要机械套用固定结构，段落长短交替（短段 1-2 句强调，长段 4-6 句深入论述）
- 开头由内容自然决定：可以从问题切入、文献切入、现象观察或直接陈述开始
- 句式多样：陈述、设问、对比交替使用
- 段落间用内容逻辑衔接，而非固定过渡词
...
## 行文要求
- 段落不必等长：短段 1-2 句强调观点，长段 4-5 句展开论述
- 开头由内容自然决定：可以从一个故事、一个反常识观点、一个痛点问题或个人经历开始
- 句式多样：陈述、设问、反问交替使用
- 不要机械套用"首先其次最后"式过渡，用内容逻辑自然衔接
...
## 行文要求
- 段落长短交替，避免通篇等长
- 开头由内容自然决定：可以从一个场景、一段对话、一个意象或直抒胸臆开始
- 用内容情绪带动段落过渡，而非固定结构
...
## 行文要求
- 段落长短交替，避免通篇等长
- 开头由内容自然决定（痛点问题、惊人数据、反常识观点、或一个具体场景）
- 句式多样，避免"首先其次最后"式过渡
...
- 代码示例可运行、有注释
- 关键行加注释说明
- 代码块必须标注语言（如 typescript、rust、json、bash）
...
## 行文要求
- 段落长短交替：短段 1-2 句强调关键点，长段 4-6 句深入展开
- 开头由内容自然决定：可以从一个实际场景、一个常见问题或一段代码开始
- 段落间用内容逻辑衔接，而非固定过渡词
- 适当融入个人经验或踩坑经历，增加可信度
...
## 行文要求
- 段落长短交替：短段用于强调核心卖点，长段展开论述
- 开头由内容自然决定：可以从痛点场景、数据冲击或用户故事开始
- 句式多样：陈述、设问、反问交替使用
...
## 行文要求
- 段落长短交替：导语段落可以稍长展开背景，后续段落简短精炼
- 开头由新闻事件本身决定：核心事实先行，避免空泛背景铺垫
- 段落间用内容推进衔接
