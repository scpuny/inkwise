...
import { getAllBuiltinSkills, type WritingSkill, type SkillPhase, type StyleDimension } from "../lib/writingSkill";
...
function WritingStylesSection() {
  ...
  useEffect(() => {
    (async () => {
      setLoading(true);
      try {
        const m = await import("../lib/writingSkill");
