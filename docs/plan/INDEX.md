...
> **当前版本**: **v3.0** — Sprint 6-8 完成 + Phase 1-6 迁移完成 + 合并到 `main` 🎉 | 最后更新: 2026-07-12
...
| **19** | **[架构重构 v3.0](19-architecture-rewrite.md)** | **完整方案：存储统一 + 分层拆分 + 净化** | 🟢 **Sprint 6-8 已实施** |
| **20** | **[迁移计划](20-migration-plan.md)** | **v3.0 渐进迁移路线：旧代码→新架构** | 🆕 **实施中** |
...
```
main ← v3.0 ← codex/v3.0-s6（已合并）
  │  Sprint 6-8 完成 + Phase 1-6 迁移 + 死代码清理
  │
  └── v2.1.0-alpha      旧版
  └── v2.0.0             旧版
```
